...
import { defineTool, err, jsonObjectArg, ok } from "./types.js";
...
export const httpTool = defineTool({
  ...
  inputSchema: {
    ...
    headers: jsonObjectArg(z.record(z.string(), z.string()))
      .optional()
      .describe("request headers (object, or a JSON-stringified object)"),
    body: z
      .string()
      .optional()
      .describe(
