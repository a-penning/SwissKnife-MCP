...
export const textTool = defineTool({
  ...
  description:
    ...
    "  • 'sort-lines' — sort lines asc/desc, optionally numerically, optionally deduping in the same pass.\n" +
    ...
    "  • 'escape' / 'unescape' — JSON string body, POSIX shell single-quoting, or regex metacharacters.\n" +
    "\n" +
  ...
  inputSchema: {
    ...
    numeric: z
      .boolean()
      .default(false)
      .describe("sort-lines: compare numerically"),
    unique: z.boolean().default(false).describe("sort-lines: drop duplicates"),
    form: z
